...
/**
 * {@code ComponentAccessor}s are helper objects to access repeated read accesses to {@code AgentComponent}s faster than
 ...
 */
public interface ComponentAccessor<A extends Agent<A, ?>, T extends AgentComponent> {
    /**
