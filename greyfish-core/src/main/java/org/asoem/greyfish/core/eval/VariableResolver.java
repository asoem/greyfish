...
public interface VariableResolver {
     ...
     */
    @Nullable
    Object resolve(String varName) throws VariableResolutionException;

    /**
     * Get the {@code VariableResolver} which is connected to this {@code VariableResolver}, which will be used to
     * resolve variables if this one cannot resolve a queried variable
     *
    ...
    /**
     * Add a {@code VariableResolver} to this resolver to build a chain of resolvers which will be queried for a
     * variable.
     *
