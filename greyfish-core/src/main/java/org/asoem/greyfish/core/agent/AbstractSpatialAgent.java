 ...
 */
public abstract class AbstractSpatialAgent<A extends SpatialAgent<A, BasicSimulationContext<S, A>, P, ?>, S extends SpatialEnvironment2D<A, ?>, P extends Object2D, AC extends AgentContext<A>>
