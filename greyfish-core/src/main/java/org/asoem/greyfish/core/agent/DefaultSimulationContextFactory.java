 ...
 */
public final class DefaultSimulationContextFactory<S extends DiscreteTimeEnvironment<A>, A extends Agent<?>>
        implements SimulationContextFactory<S, A> {

    private DefaultSimulationContextFactory() {
    }

    public static <S extends DiscreteTimeEnvironment<A>, A extends Agent<?>> DefaultSimulationContextFactory<S, A> create() {
