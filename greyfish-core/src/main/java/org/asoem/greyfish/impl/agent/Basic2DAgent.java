 ...
 * org.asoem.greyfish.impl.simulation.Basic2DEnvironment}.
 */
public interface Basic2DAgent extends SpatialAgent<Basic2DAgent, BasicSimulationContext<Basic2DEnvironment, Basic2DAgent>, Point2D, Basic2DAgentContext> {
    /**
