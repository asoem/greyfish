...
public final class AgentTraits {
    ...
    public static <T> T mutate(AgentTrait<T, A> component) {
        return component.mutate(component.getAllele());
    }

    public static <T> T mutate(AgentTrait<T, A> component, Object t) {
        return component.mutate(component.getAlleleClass().cast(t));
    }

    @SuppressWarnings("unchecked") // is checked
    public static <T> T segregate(AgentTrait<T, A> agentTrait, Object allele1, Object allele2) {
