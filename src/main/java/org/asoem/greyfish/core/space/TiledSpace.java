        ...
        if (xd > xo) { // east
            ...
            if (intersection != null) {
                if (tile.hasBorder(TileDirection.EAST))
                    return ImmutableLocation2D.at(intersection.getX() - (intersection.getX() - xo) * 0.000000000001,
                            intersection.getY() - (intersection.getY() - yo) * 0.000000000001);
                else
                    if (follow1 == null) follow1 = TileDirection.EAST; else follow2 = TileDirection.EAST;
            }
        }
