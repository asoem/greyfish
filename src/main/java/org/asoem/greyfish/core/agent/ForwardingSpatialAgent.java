 ...
 * Time: 15:19
 */
public abstract class ForwardingSpatialAgent<A extends SpatialAgent<A, S, P>, S extends SpatialSimulation<A, ?>, P extends Object2D> extends ForwardingAgent<A, S> implements SpatialAgent<A, S, P> {
