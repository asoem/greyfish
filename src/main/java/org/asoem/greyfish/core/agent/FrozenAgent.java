 ...
 */
public class FrozenAgent<A extends SpatialAgent<A, S, P>, S extends SpatialSimulation2D<A, Z, P>, P extends Object2D, Z extends Space2D<A, P>> extends AbstractSpatialAgent<A, S, P> implements Serializable {
    ...
    public static <A extends SpatialAgent<A, S, P>, S extends SpatialSimulation2D<A, Z, P>, P extends Object2D, Z extends Space2D<A, P>> Builder<A, S, P, Z> builder(Population population) {
        return new Builder<A, S, P, Z>(population);
    }

    public static class Builder<A extends SpatialAgent<A, S, P>, S extends SpatialSimulation2D<A, Z, P>, P extends Object2D, Z extends Space2D<A, P>> implements org.asoem.greyfish.utils.base.Builder<FrozenAgent<A, S, P, Z>>, Serializable {
