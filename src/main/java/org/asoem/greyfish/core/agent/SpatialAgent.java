 ...
 * Time: 10:32
 */
public interface SpatialAgent<A extends SpatialAgent<A, S, P>, S extends SpatialSimulation2D<A, ?, P>, P extends Object2D> extends Agent<A, S>, Moving<Motion2D>, Projectable<P> {
