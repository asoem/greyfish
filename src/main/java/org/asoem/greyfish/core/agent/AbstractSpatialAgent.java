 ...
 * Time: 10:13
 */
public abstract class AbstractSpatialAgent<A extends Agent<A, S>, S extends SpatialSimulation<A, ?, P>, P extends Object2D> extends AbstractAgent<A, S> implements SpatialAgent<A, S, P> {
