...
public class CompatibilityAwareResourceInteractionTest {
    ...
    public void testNormalInteraction() throws Exception {
        ...
        DoubleProperty energyStorage = DoubleProperty.with()
                ...
                .initialValue(0.0)
                .build();
        GFProperty trait1 = DoubleProperty.with().lowerBound(0.0).upperBound(1.0).initialValue(0.3).build();
        ...
        ResourceProperty resourceProperty = new ResourceProperty.Builder()
                ...
                .initialValue(1.0)
                .build();
        GFProperty trait = DoubleProperty.with().lowerBound(0.0).upperBound(1.0).initialValue(0.6).build();
