...
public class ImmutableAgentTest {
    ...
    public void testGetGene() throws Exception {
        ...
        MatcherAssert.assertThat(ret, is(equalTo(gene)));
    }
    ...
    public void testDeepClone() throws Exception {
        ...
        // then
        MatcherAssert.assertThat(clone.getPopulation(), is(equalTo(population)));
        MatcherAssert.assertThat(clone.getActions(), is(equalTo(componentListMock)));
        MatcherAssert.assertThat(clone.getProperties(), is(equalTo(componentListMock)));
        MatcherAssert.assertThat(clone.getTraits(), is(equalTo(componentListMock)));
    }
}
